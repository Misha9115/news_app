...
class _RestApiNews implements RestApiNews {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NewsListDto>(Options(
            ...
            .compose(_dio.options,
                '/everything?q=bitcoin&apiKey=ba07744ce70944eb8b6f23740d1e5106',
  ...
  Future<NewsListDto> getNewsWithPagination(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<
        NewsListDto>(Options(
            method: 'GET', headers: _headers, extra: _extra)
        .compose(_dio.options,
            '/everything?q=bitcoin&apiKey=ba07744ce70944eb8b6f23740d1e5106&pageSize=${pageSize}&page=${page}',
            queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = NewsListDto.fromJson(_result.data!);
    return value;
  ...
  @override
  Future<NewsListDto> getNewsWithParams(q, apiKey, pageSize, page) async {
    const _extra = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<
        NewsListDto>(Options(
            method: 'GET', headers: _headers, extra: _extra)
        .compose(_dio.options,
            '/everything?q=${q}&apiKey=ba07744ce70944eb8b6f23740d1e5106&pageSize=${pageSize}&page=${page}',
            queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = NewsListDto.fromJson(_result.data!);
    return value;
